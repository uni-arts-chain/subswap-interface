...
import { Currency, currencyEquals, ETHER, Percent, WETH } from '@subswap/sdk'
                    ...
                    {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                      <RowBetween style={{ justifyContent: 'flex-end' }}>
                        {oneCurrencyIsETH ? (
                          ...
                          <StyledInternalLink
                            to={`/remove/${
                              currencyA && currencyEquals(currencyA, WETH[chainId]) ? ETHER.symbol : currencyIdA
                            }/${currencyB && currencyEquals(currencyB, WETH[chainId]) ? ETHER.symbol : currencyIdB}`}
                          >
                            Receive {ETHER.symbol}
                          </StyledInternalLink>
                        ) : null}
                      </RowBetween>
                    ) : null}
