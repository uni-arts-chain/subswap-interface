...
import { ChainId, JSBI, Percent, Token, WETH } from '@subswap/sdk'
...
export const MILK = new Token(ChainId.BSC_MAINNET, '0x8E9f5173e16Ff93F81579d73A7f9723324d6B6aF', 18, 'MILK', 'Milk Protocol')

export const T_DAI = new Token(ChainId.BSC_TESTNET, '0xEC5dCb5Dbf4B114C9d0F65BcCAb49EC54F6A0867', 18, 'DAI', 'Dai Token')
export const T_BUSD = new Token(ChainId.BSC_TESTNET, '0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee', 18, 'BUSD', 'BUSD Token')
export const T_USDT = new Token(ChainId.BSC_TESTNET, '0x337610d27c682E347C9cD60BD4b3b107C9d34dDd', 18, 'USDT', 'Tether USD')
...
export const DEFAULT_TOKEN_LIST_URL = 'tokens'
