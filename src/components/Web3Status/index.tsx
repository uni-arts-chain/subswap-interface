...
const Web3StatusConnected = styled(Web3StatusGeneric)<{ pending?: boolean }>`
  ...
  border: 1px solid ${({ pending, theme }) => (pending ? theme.primary1 : theme.primary1)};
  color: ${({ pending, theme }) => (pending ? theme.white : 'white')};
  font-weight: 500;
  :hover,
  :focus {
    background-color: ${({ pending, theme }) =>
      pending ? darken(0.05, theme.primary1) : lighten(0.05, theme.primary1)};

    :focus {
      border: 1px solid ${({ pending, theme }) => (pending ? darken(0.1, theme.primary1) : darken(0.1, theme.primary1))};
    }
  }
`
